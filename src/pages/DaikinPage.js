...
import CaseDaikin from "partsproducts/CaseDaiken";
import Footer from "parts/Footer";

export default class CaseDaikinPage extends Component {
  componentDidMount() {
    window.scrollTo(0, 0);
  }
    ...
    return (
      <>
        <Helmet>
          ...
          />
          <link rel="canonical" href="https://nubeio.com/daikin/ " />
          <meta
            property="og:title"
          ...
          <meta
            ...
            content="Discover how Nube iO transforms buildings with scalable automation. Browse our case studies and implementation scenarios to see real-world results in action."
          />
          <meta property="og:url" content="https://nubeio.com/daikin/" />
        </Helmet>
