...
export default function CtaSoftware() {
  return (
    <section className="lg:py-32 px-8 pb-16 mt-12">
      <div className="container mx-auto lg:max-w-screen-xl">
        <div className="flex flex-col items-center rounded-lg bg-gray-100 dark:bg-theme-tarjet dark:border border-theme-border p-8 text-center md:rounded-xl lg:p-16 ">
