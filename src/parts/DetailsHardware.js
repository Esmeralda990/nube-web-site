...
export default function DetailsHardware() {
  return (
    <div className="container mx-auto lg:max-w-screen-xl">
      <section className="sm:items-center lg:items-start sm:flex-row pt-8">
        <div className="w-full flex flex-col px-5 mb-5 sm:mb-0 sm:px-12 sm:mt-6 lg:mt-6 xl:mt-8">
          <h2 className="text-2xl lg:text-5xl text-theme-blue text-center items-center font-bold leading-tight mb-16 max-w-3xl mx-auto dark:text-white ">
