    ...
    <section className="hero sm:items-center lg:items-start sm:flex-row">
      <div className="w-full px-5 flex flex-col mb-5 sm:px-12 sm:mt-6 lg:w-1/2 lg:mt-6 xl:pl-12 xl:mt-20">
        <Fade direction="up" triggerOnce>
          <h1 className="text-2xl lg:text-6xl text-theme-blue font-bold leading-tight mb-5 mt-12">
        ...
        <Fade delay={500} triggerOnce>
          <div className="flex space-x-4 mt-8">
            ...
            <Button
              href="/solutions/"
              type="link"
              className="text-sm sm:text-sm md:text-base lg:text-lg flex w-48 h-12 md:w-64 md:h-14 justify-center px-8 py-3 text-white  bg-theme-teal rounded-xl transition duration-300 ease-in-out hover:scale-105 hover:bg-white border border-theme-teal hover:text-black "
            >
              Our solutions
