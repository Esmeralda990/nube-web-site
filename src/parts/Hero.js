...
import BuildWebsite from "../assets/images/hero/IoT-Environmental-Monitoring-Animation_FINAL.gif";
  ...
  return (
    <section className="hero">
      <div className="w-full lg:w-1/2 xl:pl-12 sm:pr-2 mt-8">
        ...
        Nube iO is a complete end to end building automation solution with no software licensing.
        </p>
