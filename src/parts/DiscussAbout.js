...
import CardImag2 from "../assets/images/ImgFooter/Card01.svg";

export default function DiscussAB() {
  return (
    <section className="relative w-full flex justify-center py-16 px-4">
      <div className="relative lg:max-w-[105rem] w-full rounded-3xl overflow-hidden drop-shadow-[0_4px_8px_rgba(0,0,0,0.18)]">
        <img
          src={bgImg}
          alt="Background"
