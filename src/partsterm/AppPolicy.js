        ...
        <div className="w-full flex flex-col px-5 mb-5 sm:mb-0 sm:px-12 sm:mt-6 lg:mt-6 xl:mt-16">
          ...
          <Fade direction="up" triggerOnce delay={300}>
            <div className="space-y-6">
              ...
              <p className="text-base font-light text-gray-700 leading-relaxed mb-6">
                This privacy notice for Nube iO Pty Ltd (“Company”, “we”, “us”,
              ...
              <ul className="list-inside list-disc text-base font-light text-gray-700 mb-6">
                <li>
                  Download and use our mobile application (DASH iO) , or any
              ...
              <ul className="list-inside list-disc text-base font-light text-gray-700 mb-6">
                <li>
                  ...
                  personal information depending on how you interact with Nube
                  iO Pty Ltd and the Services, the choices you make, and the
                ...
                <li>
                  ...
                  so. <strong>Click here to learn more.</strong>
                </li>
                <li>
                  <strong>
              ...
              <p className="text-base font-light text-gray-700 leading-relaxed mb-6">
                ...
                device’s reminders, storage, social media accounts, nfc, and
              ...
              <p className="text-base font-light text-gray-700 leading-relaxed mb-6">
                ...
                Cemetery Rd Helensburgh, NSW 2508, Australia, or by referring to
                the contact details at the bottom of this document, If you have
              ...
              <table className="mi-tabla">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      Name, contact information, education, employment history,
              ...
              <p className="text-base font-light text-gray-700 leading-relaxed mb-6">
                Nube iO Pty Ltd has not disclosed or sold any personal
                information to third parties for a business or commercial
                purpose in the preceding twelve (12) months. Nube iO Pty Ltd
              ...
              <p className="text-base font-light text-gray-700 leading-relaxed mb-6">
                ...
                email us at{" "}
                <a href="mailto:info@nube-io.com">info@nube-io.com</a> or by
                post to:
              </p>
              <p className="text-base font-light text-gray-700 leading-relaxed mb-6">
                Nube iO Pty Ltd
